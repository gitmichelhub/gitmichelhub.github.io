...
AI Side Project: A transcription service tailored for students and journalists conducting qualitative analysis, featuring speaker diarization and accurate timestamps. The MVP is powered by Azure AI Services and hosted on Vercel, providing a seamless and efficient solution for converting interviews into structured text: [interviewtotext.com](https://interviewtotext.com)



---

**I am currently full time employed as an IT Consultant at MHP - A Porsche Company.**
...
Successfully certified 250+ individuals in SAFe methodology, with an average rating of 4.8/5 across 100+ feedbacks. Trainings are usually 2 full days with groups up to 20 people. 
...
facilitated seminars and lectures, assisting doctoral candidates in the “Introduction to Business Management” course, helping students grasp key business concepts.
...
**Student Council President** | High School  
...
I went to TU BS, which is close the VW Headquarter. During my studies I had a few side projects (bonding e.V., work at the Institute of Management, Red Bull Brand Management and Jobs like driving for Europcar) that you read above. My Thesis was about "Relationship between Leaders and Employees in the context of remote and flexible work".